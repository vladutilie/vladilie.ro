...
<div className='rounded-md border p-2 bg-gray-50 dark:bg-slate-900'>
    ...
    3. <a href="/blog/migrare-thinkific-wordpress-partea-3-import-progress">Partea 3: Import progres</a>
    4. <a href="/blog/migrare-thinkific-wordpress-partea-4-import-recenzii">Partea 4: Import recenzii</a>
    5. <a href="/blog/migrare-thinkific-wordpress-partea-5-alte-adaptari">Partea 5: Alte adaptări și concluzii</a>
</div>
...
Pentru noua casă a site-ului Masterclass Onlone am ales modulul <a href="https://wordpress.org/plugins/tutor/" target="_blank" className="after:content-['_↗']">Tutor LMS</a> configurat împreună cu <a href="https://wordpress.org/plugins/woocommerce/" target="_blank" className="after:content-['_↗']">WooCommerce</a> pentru procesarea comenzilor, cu plată, facturare și restul integrărilor, aici n-am să intru mai mult în detalii.
...
<img src="https://res.cloudinary.com/vladilie-ro/image/upload/v1706375897/blog/1.%20migrate-thinkific-to-wordpress/thinkific-export-users_iqqirf.webp" />
...
```
Dintre toate datele, am avea nevoie doar de următoarele:
- First Name
- Last Name
- Date created
- Email
...
De fapt, nici nu există această posibilitate din panoul de control de la Thinkific.
...
<img src="https://res.cloudinary.com/vladilie-ro/image/upload/v1706377907/blog/1.%20migrate-thinkific-to-wordpress/thinkific-export-user-course-progress_ez6b8x.webp" />
...
O să vezi mai departe în partea a doua a seriei de articole că am făcut un compromis și am tratat doar progresul cu valoarea `100`.
