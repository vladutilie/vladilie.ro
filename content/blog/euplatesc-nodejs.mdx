...
locale: ro
featuredImage: https://gcdahtftlmucxetygvev.supabase.co/storage/v1/object/public/vladilie.ro-media/euplatesc-nodejs.webp
...
Nu de puține ori mi-a fost dat să integrez API-ul de la serviciul de plăți online <a href="https://euplatesc.ro" target="_blank" className="after:content-['_↗']">EuPlătesc</a> în proiectele pe care le-am întreprins.
...
Dar să trecem peste asta, tot răul spre bine, acum există biblioteca `euplatesc` pentru Node.js publicată pe <a href="https://www.npmjs.com/package/euplatesc" taget="_blank">npmjs.com</a> și pe <a href="https://github.com/vladutilie/euplatesc/pkgs/npm/euplatesc" target="_blank">Github Packages</a> 🎉.
