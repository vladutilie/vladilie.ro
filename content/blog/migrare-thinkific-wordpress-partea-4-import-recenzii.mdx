---
title: 'Cum să migrezi de la Thinkific la WordPress. Partea 4: Import recenzii'
locale: ro
...
---
În <a href="/blog/migrare-thinkific-wordpress-partea-3-import-progres">articolul anterior</a>, partea a treia a acestei serii de 5 articole, am descris implementarea comenzii WP-CLI de importare a progresului cursurilor pentru utilizatori.
...
## Încheiere
Cu rularea ultimei comenzi `WP-CLI` avem și recenziile adăugare:
```sh
$ wp thinkific import reviews
```

Migrarea este finalizată, în <a href="/blog/migrare-thinkific-wordpress-partea-5-alte-adaptari">următorul articol</a> voi mai face câteva adaptări ale temei, ale șabloanelor `Tutor LMS` și `WooCommerce`.
