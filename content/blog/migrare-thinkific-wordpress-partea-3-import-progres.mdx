---
title: 'Cum să migrezi de la Thinkific la WordPress. Partea 3: Import progres'
locale: ro
...
---
În <a href="/blog/migrare-thinkific-wordpress-partea-2-planificare-pregatire-date">partea a doua</a> a acestei serii de 5 articole am vorbit despre cum am făcut implementarea pentru comanda personalizată WP-CLI de importare a utilizatorilor.
...
$time         = time();
```
Am refolosit metoda `parse_csv_content` pentru a transforma liniile din `CSV` într-un vector, metodă pe care am definit-o în <a href="/blog/migrare-thinkific-wordpress-partea-2-import-utilizatori">partea a doua</a> la importul utilizatorilor.
...
Dacă îți amintești din prima parte de la <a href="/blog/migrare-thinkific-wordpress-partea-1-planificare-pregatire-date">pregătirea datelor</a>, prima linie a fișierului `CSV` de progres arăta așa:
```csv
...
În <a href="/blog/migrare-thinkific-wordpress-partea-4-import-recenzii">următorul articol</a> voi folosi API-ul de comentarii din WordPress pentru migrarea recenziilor, așa că te invit să-l studiezi 😎.
