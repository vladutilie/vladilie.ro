...
## About the client/business
    ...
    <a href="https://tablouricolorate.ro" title="TablouriColorate website" target="_blank" className="after:content-['_↗']">TablouriColorate</a> is a dynamic small business based in Târgu Mureș, Romania, specializing in custom printing products.
...
I have used the <a href="https://mui.com" title="MUI website" target="_blank" className="after:content-['_↗']">MUI</a> components and the WooCommerce API.
...
The WordPress plugin adheres to the official <a href="https://developer.wordpress.org/coding-standards/wordpress-coding-standards/" title="WordPress Coding Standards (WPCS) page" target="_blank" className="after:content-['_↗']">WordPress Coding Standards (WPCS)</a> guidelines.
