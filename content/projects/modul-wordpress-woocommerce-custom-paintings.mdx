---
title: Modul WordPress de produse personalizate pentru WooCommerce
locale: en
...
date: November 27, 2023 09:17:08
---
...
They print photos on canvas material and help their customers to create their custom products in the most innovative, simple, and fun way possible.
...
How many users, and that many photo sizes, so it was a bit frustrating.
...
After some magic tricks, the solution was done, faster and very nicely designed.
...
I have implemented another similar page for posters, banners, and stickers and a nice thing was a page for customized photo collages.
It lets the user upload many photos in the same frame in 8 different patterns like the below:
