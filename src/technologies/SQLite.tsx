...
export const SQLite = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 237' {...props}>
    <title>{'sqlite-svgrepo-com-svg'}</title>
    <defs>
      <linearGradient id='g1' x1={12596.4} y1={517.2} x2={12596.4} y2={23010.7} gradientUnits='userSpaceOnUse'>
        ...
        <stop offset={0.9} stopColor='#0f80cc' />
